...
public class TrRythCardiaque extends AntecedentMedicaux{
    private Double anciennete;
    private String traitement;
    private Boolean equilibre;

    public TrRythCardiaque() {
    }

    public TrRythCardiaque(Double anciennete, String traitement, Boolean equilibre) {
